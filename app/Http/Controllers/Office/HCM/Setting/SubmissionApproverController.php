...
namespace App\Http\Controllers\Office\HCM\Setting;
...
class SubmissionApproverController extends Controller
{
    ...
    {
        $groups = ['ATTENDANCE', 'OUTSTATION', 'LEAVE', 'RESIGNATION'];
        ...
        return Inertia::render('Office/HCM/Setting/SubmissionApprover/Index', $data);
    }
