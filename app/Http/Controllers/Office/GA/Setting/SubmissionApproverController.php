...
namespace App\Http\Controllers\Office\GA\Setting;
...
class SubmissionApproverController extends Controller
{
    ...
    {
        $groups = ['INSTALL_REPAIR', 'EVENT', 'EQUIPMENT', 'MATERIAL', 'VEHICLE'];
        ...
        return Inertia::render('Office/GA/Setting/SubmissionApprover/Index', $data);
    }
