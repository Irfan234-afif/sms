...
class DocumentationController extends Controller
{
    public function index()
    {
        $submissions = Submission::whereHas('submitter.profile.user', function ($user) {
            ...
            $group->where('code', 'DOCUMENTATION');
        });
        ...
        return Inertia::render('Office/MyProfile/Submission/Documentation/Index', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $submissionService = new SubmissionStoreService('DOCUMENTATION', $submitter);
