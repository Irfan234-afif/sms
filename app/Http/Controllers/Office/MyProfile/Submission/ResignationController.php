...
class ResignationController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Office/MyProfile/Submission/Resignation/Index', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $submissionService = new SubmissionStoreService('RESIGNATION', $submitter);
