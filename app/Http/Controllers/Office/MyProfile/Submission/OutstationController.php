...
class OutstationController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Office/MyProfile/Submission/Outstation/Index', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $submissionService = new SubmissionStoreService('OUTSTATION', $submitter);
