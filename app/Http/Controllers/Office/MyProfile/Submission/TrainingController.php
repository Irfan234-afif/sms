...
class TrainingController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Office/MyProfile/Submission/Training/Index', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $submissionService = new SubmissionStoreService('TRAINING', $submitter);
