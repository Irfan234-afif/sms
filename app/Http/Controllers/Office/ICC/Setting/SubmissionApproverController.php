...
namespace App\Http\Controllers\Office\ICC\Setting;
...
class SubmissionApproverController extends Controller
{
    ...
    {
        $groups = ['DESIGN', 'DOCUMENTATION', 'MEDIA_POST', 'BROADCAST', 'CARD'];
        ...
        return Inertia::render('Office/ICC/Setting/SubmissionApprover/Index', $data);
    }
