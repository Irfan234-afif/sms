...
namespace App\Http\Controllers\Office\ICC\Approval;
...
class MediaPostController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Office/ICC/Approval/MediaPost/Index', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            $submissionService = new SubmissionStoreService('MEDIA_POST', $submitter);
