    ...
    <div v-show="show" class="fixed inset-0 z-50 flex overflow-y-auto px-4 py-6 sm:px-0" scroll-region>
      ...
      >
        <div v-show="show" class="fixed inset-0 transform transition-all" @click="close">
          <div class="absolute inset-0 bg-gray-900 opacity-65" />
        </div>
      </transition>
      ...
      >
        <div v-show="show" class="mt-10 w-full">
          <div class="transform overflow-hidden transition-all sm:mx-auto" :class="maxWidthClass">
