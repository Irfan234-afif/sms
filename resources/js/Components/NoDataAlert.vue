<template>
  ...
  >
    <svg
      class="me-3 inline h-5 w-5 shrink-0 text-gray-500 dark:text-gray-400"
      aria-hidden="true"
    ...
    <div><span class="font-medium">Data tidak tersedia!</span> Tidak ada data yang bisa ditampilkan.</div>
  </div>
</template>
