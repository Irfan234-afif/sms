      ...
      <ul class="space-y-2">
        ...
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap">Kandidat</span>
          </Link>
        </li>
        <li>
          <Link
            :href="route('office.hcm.employee')"
            class="group flex items-center rounded-lg p-2 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="ml-3 flex-1 whitespace-nowrap">Karyawan</span>
          </Link>
        </li>
        <li>
          <Link
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap">Penempatan</span>
          </Link>
        </li>
        <li>
          <button
