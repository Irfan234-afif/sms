  ...
  <div>
      ...
      <ul class="mt-5 space-y-2 border-t border-gray-200 pt-5 dark:border-gray-700">
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">My Profile</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">ICC</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">HCM</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">GA</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">QRD</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <li>
          ...
          >
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">Finance</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
    ...
    >
      ...
      <div
        id="tooltip-settings"
        role="tooltip"
        class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-xs font-medium text-white opacity-0 shadow-sm transition-opacity duration-300"
        data-popper-placement="top"
        data-popper-reference-hidden=""
        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(149.6px, -64px, 0px)"
      >
        Pengaturan
        <div
          class="tooltip-arrow"
      ...
      <!-- Dropdown -->
      <div
        class="z-50 my-4 hidden list-none divide-y divide-gray-100 rounded bg-white text-xs shadow dark:bg-gray-700"
        id="language-dropdown"
        data-popper-placement="bottom"
        data-popper-reference-hidden=""
        data-popper-escaped=""
        style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(201.6px, 890.4px, 0px)"
      >
