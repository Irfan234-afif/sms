      ...
      <ul class="space-y-2">
        ...
        <li>
          ...
          <ul id="dropdown-activity" class="hidden space-y-2 py-2">
            <li>
              <Link
                :href="route('office.icc.activity.admissionStudent')"
        ...
        <li>
          <button
            type="button"
            class="group flex w-full items-center rounded-lg p-2 text-xs font-medium text-gray-900 transition duration-75 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
            aria-controls="dropdown-publication"
            data-collapse-toggle="dropdown-publication"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <span class="ml-3 flex-1 whitespace-nowrap text-left">Publikasi</span>
            <svg
              aria-hidden="true"
              class="h-5 w-5"
              fill="currentColor"
          ...
          <ul id="dropdown-publication" class="hidden space-y-2 py-2">
            ...
            <li>
              <Link
                :href="route('office.icc.publication.career')"
                class="group flex w-full items-center rounded-lg p-2 pl-11 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                Jenjang Karir
              </Link>
        ...
        <li>
          <button
            ...
            data-collapse-toggle="dropdown-management"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <ul id="dropdown-management" class="hidden space-y-2 py-2">
            <li>
              <Link
                :href="route('office.icc.management.schoolYear')"
                class="group flex w-full items-center rounded-lg p-2 pl-11 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                >Tahun Ajaran</Link
              >
            </li>
            <li>
              <Link
                :href="route('office.icc.management.admissionStage')"
                class="group flex w-full items-center rounded-lg p-2 pl-11 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
        ...
        <li>
          ...
          <ul id="dropdown-setting" class="hidden space-y-2 py-2">
            <li>
              <Link
                :href="route('office.icc.setting.submissionApprover')"
                class="group flex w-full items-center rounded-lg p-2 pl-11 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
