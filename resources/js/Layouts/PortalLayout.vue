    ...
    <nav class="border-gray-200 bg-white dark:bg-gray-900">
      <div class="mx-auto flex max-w-screen-2xl flex-wrap items-center justify-between p-4">
        ...
        <div class="flex items-center space-x-1 md:order-2 md:space-x-2 rtl:space-x-reverse">
          <button
            type="button"
            class="flex rounded-full bg-gray-800 text-xs focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 md:me-0"
            id="user-menu-button"
            aria-expanded="false"
          ...
          <!-- Dropdown menu -->
          <div
            class="z-50 my-4 hidden list-none divide-y divide-gray-100 rounded-lg bg-white text-xs shadow-sm dark:divide-gray-600 dark:bg-gray-700"
            id="user-dropdown"
          >
            <div class="px-4 py-3">
            ...
            <ul class="py-2" aria-labelledby="user-menu-button">
              <li>
                <Link
                  ...
                  method="post"
                  as="button"
                  class="block w-full px-4 py-2 text-start text-xs text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                  >Keluar</Link
                >
              </li>
            </ul>
