    ...
    >
      <div class="flex flex-wrap items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <Link :href="route('office')" class="mr-4 flex items-center justify-between">
            <img src="/assets/icons/main-foundation-logo.png" class="mr-3 h-10" alt="Office Logo" />
          </Link>
        </div>
        <div class="flex items-center lg:order-2">
          ...
          <div
            v-if="false"
            class="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded-xl bg-white text-xs shadow-lg dark:divide-gray-600 dark:bg-gray-700"
            ...
            style="
              ...
              margin: 0px;
              transform: translate3d(1265.6px, 60.8px, 0px);
            "
          >
            <div
              class="block bg-gray-50 px-4 py-2 text-center text-xs font-medium text-gray-800 dark:bg-gray-600 dark:text-gray-300"
            >
              Notifications
            </div>
            <div>
              ...
              >
                ...
                <div class="w-full pl-3">
                  <div class="mb-1.5 text-xs font-normal text-gray-500 dark:text-gray-400">
                    New message from
                    <span class="font-medium text-gray-900 dark:text-white">Bonnie Green</span>: "Hey, what's up? All
              ...
              >
                ...
                <div class="w-full pl-3">
                  <div class="mb-1.5 text-xs font-normal text-gray-500 dark:text-gray-400">
                    <span class="font-medium text-gray-900 dark:text-white">Leslie Livingston</span>
              ...
              <Link href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <div class="w-full pl-3">
                  <div class="mb-1.5 text-xs font-normal text-gray-500 dark:text-gray-400">
                    <span class="font-medium text-gray-900 dark:text-white">Robert Brown</span>
          ...
          >
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              ...
              >
                ...
                <div class="text-xs text-gray-900 dark:text-white">Finance</div>
              </Link>
            </div>
          </div>
          <button
            type="button"
            class="mx-3 flex rounded-full bg-gray-800 text-xs focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 md:mr-0"
            id="user-menu-button"
            aria-expanded="false"
          ...
          <!-- Dropdown menu -->
          <div
            class="z-50 my-4 hidden w-56 list-none divide-y divide-gray-100 rounded-xl bg-white text-xs shadow dark:divide-gray-600 dark:bg-gray-700"
            id="dropdown"
            data-popper-placement="bottom"
            style="
              position: absolute;
          ...
          >
            <div class="px-4 py-3">
              ...
              <span class="block truncate text-xs text-gray-900 dark:text-white">{{
            ...
            <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
              <li>
                <Link
                  href="#"
                  class="block px-4 py-2 text-xs hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
            ...
            <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
              <li>
                <Link
                  :href="route('portal')"
                  class="block px-4 py-2 text-xs hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                  >Keluar Portal</Link
                >
              </li>
            </ul>
