    ...
    <template #content>
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          <h1 class="mb-4 text-base font-medium text-gray-900 dark:text-white md:mb-6">Selamat datang</h1>
          <div
            class="grid grid-cols-2 gap-6 border-b border-t border-gray-200 py-4 text-xs dark:border-gray-700 md:py-8 lg:grid-cols-4 xl:gap-16"
          >
            <div>
              <svg
                ...
                class="mb-2 h-7 w-7 text-gray-400 dark:text-gray-500"
              >
              ...
              <h6 class="mb-2 text-xs text-gray-500 dark:text-gray-400">Permintaan diproses</h6>
              <span class="flex items-center text-base font-medium text-gray-900 dark:text-white">24 </span>
              <p class="mt-2 flex items-center text-xs text-gray-500 dark:text-gray-400 sm:text-xs">
                <svg
            ...
            <div>
              ...
              <h6 class="mb-2 text-xs text-gray-500 dark:text-gray-400">Permintaan disetujui</h6>
              <span class="flex items-center text-base font-medium text-gray-900 dark:text-white">16 </span>
              <p class="mt-2 flex items-center text-xs text-gray-500 dark:text-gray-400 sm:text-xs">
                <svg
                  class="me-1.5 h-4 w-4 text-gray-500 dark:text-gray-400"
                  aria-hidden="true"
            ...
            <div>
              ...
              <h6 class="mb-2 text-xs text-gray-500 dark:text-gray-400">Permintaan ditolak</h6>
              <span class="flex items-center text-base font-medium text-gray-900 dark:text-white">8 </span>
              <p class="mt-2 flex items-center text-xs text-gray-500 dark:text-gray-400 sm:text-xs">
                <svg
                  class="me-1.5 h-4 w-4 text-gray-500 dark:text-gray-400"
                  aria-hidden="true"
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-if="!profile.attachments || profile.attachments.length === 0" class="p-4 text-center text-gray-500">
              Belum ada lampiran yang diunggah
            </div>

            <!-- Daftar lampiran -->
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div v-for="(attachment, index) in profile.attachments" :key="index" class="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-800">
                <div class="flex items-center space-x-4">
                  <!-- Icon Container -->
                  ...
                  <div>
                    <div class="text-sm font-medium text-gray-900 dark:text-white">{{ attachment.title }}</div>
                    <div class="text-xs text-gray-500 dark:text-gray-400">{{ attachment.file_name?.slice(-3) }}</div>
                  </div>
                </div>
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(academic, index) in profile.academic_records"
                :key="index"
                  ...
                  <div class="flex flex-1 items-center gap-4">
                    ...
                    <div class="p-2 rounded-lg bg-blue-50 dark:bg-gray-700">
                      <svg 
                        ...
                        viewBox="0 0 24 24"
                      >
                        <path fill="currentColor" fill-rule="evenodd" d="M9.465 2.82a5.92 5.92 0 0 1 5.07 0l6.692 3.138c1.052.493 1.523 1.564 1.523 2.542s-.47 2.05-1.523 2.543l-1.477.692v4.89c0 1.253-.628 2.463-1.772 3.097c-.752.416-1.74.917-2.78 1.316c-1.027.394-2.164.712-3.198.712s-2.171-.318-3.199-.712c-1.04-.399-2.027-.9-2.779-1.316c-1.144-.634-1.772-1.844-1.772-3.097V11.5q0-.062.01-.122a.75.75 0 0 1 1.059-.8l4.782 2.243a4.42 4.42 0 0 0 3.798 0l6.691-3.137c.403-.189.66-.64.66-1.184s-.257-.995-.66-1.184L13.9 4.179a4.42 4.42 0 0 0-3.798 0l-6.69 3.137a.75.75 0 0 1-.638-1.358zM5.75 12.439v4.187c0 .763.379 1.441.999 1.785c.716.396 1.638.862 2.59 1.227c.963.37 1.899.613 2.661.613s1.698-.243 2.662-.613a21 21 0 0 0 2.59-1.227c.62-.344.998-1.022.998-1.785v-4.187l-3.714 1.741a5.92 5.92 0 0 1-5.071 0z" clip-rule="evenodd"/><path fill="currentColor" d="M6.69 7.705a.75.75 0 0 1-.395.984L5.22 9.15c-.603.259-1 .43-1.292.594c-.276.155-.396.271-.472.387s-.135.27-.169.585c-.036.333-.037.766-.037 1.422V15a.75.75 0 0 1-1.5 0v-2.901c0-.607 0-1.12.046-1.544c.048-.45.154-.864.408-1.25c.255-.386.594-.646.989-.868c.37-.209.843-.411 1.4-.65l1.112-.476a.75.75 0 0 1 .984.394"/></svg>
                      <!-- <svg
                        class="h-6 w-6 text-blue-600 dark:text-blue-400"
                        fill="none"
                        stroke="currentColor"
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="mt-1 flex flex-col sm:flex-row sm:items-center sm:gap-3 text-xs text-gray-500 dark:text-gray-400">
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(training, index) in profile.training_records"
                :key="index"
                class="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
              >
                <div class="flex items-center justify-between p-4">
                  ...
                  <div class="flex flex-1 items-center gap-4">
                    ...
                    <div class="p-2 rounded-lg bg-blue-50 dark:bg-gray-700">
                      <svg 
                        ...
                        stroke="currentColor"
                      >
                        <path fill="currentColor" d="M4 8h16v11H4z" opacity="0.3"/><path fill="currentColor" d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2M10 4h4v2h-4zm10 15H4V8h16z"/></svg>
                    </div>
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(specialization, index) in profile.specializations"
                :key="index"
                class="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
              >
                <div class="flex items-center justify-between p-4">
                  <div class="flex flex-1 items-center gap-4">
                    ...
                    <div class="p-2 rounded-lg bg-blue-50 dark:bg-gray-700">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600 dark:text-blue-400"
                        fill="none"
                        stroke="currentColor"><path fill="currentColor" d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm-3.42 14l-.95-4.08l3.16-2.73l-4.17-.36L12 6l-1.62 3.84l-4.17.36l3.16 2.73L8.42 17L12 14.84z"/></svg>
                    </div>
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(community_involvement, index) in profile.community_involvements"
                :key="index"
                class="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
              >
                <div class="flex items-center justify-between p-4">
                  <div class="flex flex-1 items-center gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="mt-1 flex flex-col sm:flex-row sm:items-center sm:gap-3 text-xs text-gray-500 dark:text-gray-400">
                        <span>{{ community_involvement.start_date + ' - ' + community_involvement.end_date }}</span>
                      </div>
                    </div>
                  </div>
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(honor_prize, index) in profile.honor_prizes"
                :key="index"
                class="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
              >
                <div class="flex items-center justify-between p-4">
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(language_skill, index) in profile.language_skills"
                :key="index"
                class="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
              >
                <div class="flex items-center justify-between p-4">
                  <div class="flex flex-1 items-center gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="mt-1 flex flex-col sm:flex-row sm:items-center sm:gap-3 text-xs text-gray-500 dark:text-gray-400">
                        <span>{{ languageSkillLevel.find(value => value.value == language_skill.reading)?.label }}</span>
                      </div>
                    </div>
                  </div>
      ...
      <section class="bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
        <div class="px-4 2xl:px-0">
          ...
          <div class="border border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
              <div 
                v-for="(family, index) in profile.families"
                :key="index"
                class="group transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
              >
                <div class="flex items-center justify-between p-4">
                  <div class="flex flex-1 items-center gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="mt-1 flex flex-col sm:flex-row sm:items-center sm:gap-3 text-xs text-gray-500 dark:text-gray-400">
                        <span>{{ familyRelationTypes.find(value => value.value == family.relation)?.label }}</span>
                      </div>
                    </div>
                  </div>
      ...
      <Modal :show="showModal" :property="propertyModal" :maxWidth="propertyModal?.maxWidth" @close="closeModal">
        <template v-slot="{ propertyModal }">
          <AttachmentForm v-if="propertyModal?.mode == 'create-attachment' || propertyModal?.mode == 'edit-attachment'"
            :propertyModal="propertyModal"
            @close="closeModal()"></AttachmentForm>
          <AcademicForm v-if="propertyModal?.mode == 'create-academic' || propertyModal?.mode == 'edit-academic'"
            :propertyModal="propertyModal"
            @close="closeModal()"></AcademicForm>
          <CertificationForm v-if="propertyModal?.mode == 'create-certification' || propertyModal?.mode == 'edit-certification'"
            :propertyModal="propertyModal"
            @close="closeModal()"></CertificationForm>
          <TrainingForm v-if="propertyModal?.mode == 'create-training' || propertyModal?.mode == 'edit-training'"
            :propertyModal="propertyModal"
            @close="closeModal()"></TrainingForm>
          <SpecializationForm v-if="propertyModal?.mode == 'create-specialization' || propertyModal?.mode == 'edit-specialization'"
            :propertyModal="propertyModal"
            @close="closeModal()"></SpecializationForm>
          <ExperienceForm v-if="propertyModal?.mode == 'create-experience' || propertyModal?.mode == 'edit-experience'"
            :propertyModal="propertyModal"
            @close="closeModal()"></ExperienceForm>
          <LanguageSkillForm v-if="propertyModal?.mode == 'create-language-skill' || propertyModal?.mode == 'edit-language-skill'"
            :propertyModal="propertyModal"
            @close="closeModal()"></LanguageSkillForm>
          <CommunityInvolvementForm v-if="propertyModal?.mode == 'create-community-involvement' || propertyModal?.mode == 'edit-community-involvement'"
            :propertyModal="propertyModal"
            @close="closeModal()"></CommunityInvolvementForm>
          <FamilyForm v-if="propertyModal?.mode == 'create-family' || propertyModal?.mode == 'edit-family'"
            :propertyModal="propertyModal"
            @close="closeModal()"></FamilyForm>
          <HonorPrizeForm v-if="propertyModal?.mode == 'create-honor-prize' || propertyModal?.mode == 'edit-honor-prize'"
            :propertyModal="propertyModal"
            @close="closeModal()"></HonorPrizeForm>
        </template>
      </Modal>
    </template>
  </OfficeLayout>
