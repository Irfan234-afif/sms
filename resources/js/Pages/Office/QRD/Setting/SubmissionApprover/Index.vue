...
const breadcrumbs = [
  ...
  { label: 'Petugas Persetujuan', href: route('office.qrd.setting.submissionApprover') },
];
</script>
...
<template>
  <Head title="Petugas Persetujuan - Training Program" />
                  ...
                  <li v-for="(area, index) in areas.data" :key="index" class="py-3">
                    <div class="flex items-center space-x-2">
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            title: `Atur Petugas ${submission_group.name} (${area.name})`,
