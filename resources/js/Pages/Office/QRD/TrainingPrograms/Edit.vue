...
export default {
    data() {
        return {
            ...
            form: useForm({
                ...
                phases: this.phases.length ? this.phases : [this.newPhase()]
            }),
            field: {
                name: {
                    label: 'Nama Program',
    ...
    mounted() {
        console.log('Edit Program Pelatihan Mounted : ', this.program);
    },
    methods: {
        newPhase() {
            return {
        ...
        updateAssessment(module, assessmentIndex, updatedAssessment) {
            module.assessments[assessmentIndex] = updatedAssessment;
        },
        submit() {
    ...
    <OfficeLayout>
        ...
        <template #content>
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-xl font-bold mb-6">Edit Program Pelatihan</h2>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <el-option
                                v-for="item in field.status.options"
                                :key="item.value"
                                :label="item.label"
                                :value="item.value"
                            />
