...
const breadcrumbs = [
  ...
  { label: 'Permintaan Peralatan & Pemeliharaan', href: route('office.myProfile.submission.equipment') },
];
</script>
            ...
            <table class="w-full text-left text-xs text-gray-500 dark:text-gray-400">
              <thead class="bg-gray-50 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" class="p-4">Peralatan / Pemeliharaan</th>
              ...
              <tbody class="text-xs">
                ...
                >
                  ...
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.equipment.items[0].name }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.equipment.items[0].quantity }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.equipment.items[0].description }}
                    </div>
                  </th>
                  ...
                  <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center justify-end space-x-3">
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            ...
                            maxWidth: 'md',
                            data: {
                              actionUrl: route('office.myProfile.submission.equipment.delete', {
                                submission: submission,
                              }),
                              redirectUrl: route('office.myProfile.submission.equipment'),
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            title: `Permintaan Peralatan & Pemeliharaan ${submission.reference_number}`,
                            mode: 'chat-form',
                            maxWidth: '3xl',
                            data: {
