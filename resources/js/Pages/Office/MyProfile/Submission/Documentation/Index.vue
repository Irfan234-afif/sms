...
const breadcrumbs = [
  ...
  { label: 'Permintaan Dokumentasi', href: route('office.myProfile.submission.documentation') },
];
</script>
            ...
            <table class="w-full text-left text-xs text-gray-500 dark:text-gray-400">
              <thead class="bg-gray-50 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" class="p-4">Dokumentasi</th>
              ...
              <tbody class="text-xs">
                ...
                >
                  ...
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.documentation.title }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.documentation.place }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.documentation.description }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.documentation.start_date }} - {{ submission.documentation.start_date }}
                    </div>
                  </th>
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            ...
                            maxWidth: 'md',
                            data: {
                              actionUrl: route('office.myProfile.submission.documentation.delete', {
                                submission: submission,
                              }),
                              redirectUrl: route('office.myProfile.submission.documentation'),
