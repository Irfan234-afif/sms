...
const breadcrumbs = [
  ...
  { label: 'Permintaan Acara', href: route('office.myProfile.submission.event') },
];
</script>
            ...
            <table class="w-full text-left text-xs text-gray-500 dark:text-gray-400">
              ...
              <tbody class="text-xs">
                ...
                >
                  ...
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.event.place }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ submission.event.start_datetime }} - {{ submission.event.end_datetime }}
                    </div>
                  </th>
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            ...
                            maxWidth: 'md',
                            data: {
                              actionUrl: route('office.myProfile.submission.event.delete', {
                                submission: submission,
                              }),
                              redirectUrl: route('office.myProfile.submission.event'),
