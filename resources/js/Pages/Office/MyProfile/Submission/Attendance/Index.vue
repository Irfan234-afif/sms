...
const breadcrumbs = [
  ...
  { label: 'Permintaan Absensi', href: route('office.myProfile.submission.attendance') },
];
</script>
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            ...
                            maxWidth: 'md',
                            data: {
                              actionUrl: route('office.myProfile.submission.attendance.delete', {
                                submission: submission,
                              }),
                              redirectUrl: route('office.myProfile.submission.attendance'),
