...
export default {
  ...
  data() {
    return {
      ...
      loaded: true,
      isValid: false,
      actionRoute: route('office.myProfile.submission.outstation.store'),
      form: {
        submission_id: null,
      ...
      field: {
        ...
        title: {
          ...
          rules: [fieldValidation.isRequired('Perjalanan Dinas')],
          error: null,
        },
        date_range: {
          label: 'Waktu',
  ...
  created() {
    if (this.propertyModal.mode == 'submission-edit-form') {
      ...
      this.actionRoute = route('office.myProfile.submission.outstation.update');

      this.form.submission_id = submission.uuid;
      this.form.datetime = submission.datetime;
      this.form.title = submission.outstation.title;
      this.form.date_range = [submission.outstation.start_date, submission.outstation.end_date];
      this.form.description = submission.outstation.description;
    }
  },
  methods: {
    submit(status) {
