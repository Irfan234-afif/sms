...
export default {
  ...
  methods: {
    getSubmissionApprover() {
      axios
        .get(
          route('office.ga.setting.submissionApprover.getSubmissionApprover', {
    ...
    optionApprover(search, index) {
      axios
        .get(
          route('office.ga.setting.submissionApprover.optionEmployee', {
            search: search,
          }),
        )
        .then((response) => {
    ...
    submit() {
      ...
      axios
        .post(route('office.ga.setting.submissionApprover.save'), requestPayload, {
