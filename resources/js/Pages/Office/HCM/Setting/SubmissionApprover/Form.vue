...
export default {
  ...
  methods: {
    getSubmissionApprover() {
      axios
        .get(
          route('office.hcm.setting.submissionApprover.getSubmissionApprover', {
    ...
    optionApprover(search, index) {
      axios
        .get(
          route('office.hcm.setting.submissionApprover.optionEmployee', {
            search: search,
          }),
        )
        .then((response) => {
    ...
    submit() {
      ...
      axios
        .post(route('office.hcm.setting.submissionApprover.save'), requestPayload, {
