...
export default {
  ...
  methods: {
    getSubmissionApprover() {
      axios
        .get(
          route('office.icc.setting.submissionApprover.getSubmissionApprover', {
    ...
    optionApprover(search, index) {
      axios
        .get(
          route('office.icc.setting.submissionApprover.optionEmployee', {
            search: search,
          }),
        )
        .then((response) => {
    ...
    submit() {
      ...
      axios
        .post(route('office.icc.setting.submissionApprover.save'), requestPayload, {
