    ...
    <template #content>
        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800">
          ...
          <div class="overflow-x-auto">
            <table class="w-full text-left text-xs text-gray-500 dark:text-gray-400">
              ...
              <tbody class="text-xs">
                <tr
                  v-for="(operational_hour, index) in operational_hours.data"
                  :key="index"
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            ...
                            maxWidth: 'md',
                            data: {
                              actionUrl: route('office.icc.publication.operationalHour.delete', {
      ...
      <Modal :show="showModal" :property="propertyModal" :maxWidth="propertyModal?.maxWidth" @close="closeModal">
        <template v-slot="{ propertyModal }">
          ...
          />
          <DeleteConfirm
            v-if="propertyModal?.mode == 'operational-hour-delete-confirm'"
            :propertyModal="propertyModal"
            @close="closeModal()"
          />
        </template>
