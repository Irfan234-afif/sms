...
export default {
  ...
  methods: {
    submit() {
      this.$refs['operationalAreaForm'].validate((valid) => {
        if (valid) {
          this.process = true;
          ...
          axios
            .post(route('office.icc.publication.operationalArea.save'), requestPayload, {
            ...
            .catch((error) => {
              ...
              if (error.response?.data?.errors) {
                for (let field in error.response.data.errors) {
                  ...
                  this.$refs['operationalAreaForm'].validateField(field);
                }
              }
            })
            .finally(() => {
