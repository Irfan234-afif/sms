...
const breadcrumbs = [
  ...
  { label: 'Kuota Pendaftaran', href: route('office.icc.management.admissionStudentQuota') },
];
</script>
    ...
    <template #content>
                  ...
                  <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center justify-end space-x-3">
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            title: `Kuota Pendaftaran ${school.area.name}`,
                            mode: 'admission-student-quota-form',
                            maxWidth: '2xl',
                            data: {
                              school: school,
      ...
      <Modal :show="showModal" :property="propertyModal" :maxWidth="propertyModal?.maxWidth" @close="closeModal">
        <template v-slot="{ propertyModal }">
          <AdmissionStageForm
            v-if="propertyModal?.mode == 'admission-student-quota-form'"
