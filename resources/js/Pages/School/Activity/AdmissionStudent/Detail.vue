        ...
        <template #content>
            ...
            <section class="rounded-lg bg-white p-4 antialiased dark:bg-gray-900 md:p-6">
                <div class="px-4 2xl:px-0">
                    ...
                    <div class="grid gap-4 py-2 sm:gap-8 md:grid-cols-2 md:py-4">
                        ...
                        <div class="space-y-4">
                            <h2 class="text-base font-bold text-gray-900 dark:text-white">Lampiran</h2>
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    class="relative inline-flex w-full items-center border-b border-gray-200 px-4 py-3 text-sm font-medium hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700 dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:text-white dark:focus:ring-gray-500"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24"
            ...
            <Modal :show="showModal" :property="propertyModal" :maxWidth="propertyModal?.maxWidth" @close="closeModal">
                <template v-slot="{ propertyModal }">
                    ...
                    />
                    <StageForm
                        v-if="propertyModal?.mode == 'stage-form'"
                        :propertyModal="propertyModal"
                        @close="closeModal()"
                    />
                </template>
