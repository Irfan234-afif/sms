...
const breadcrumbs = [
  ...
  { label: 'Ekstrakurikuler', href: route('school.management.schoolExtracurricular') },
];
</script>
...
export default {
  props: {
    ...
    school_extracurriculars: Object,
  },
  data() {
    return {
      showModal: false,
          ...
          <DefaultButton
            ...
            @click="
              openModal({
                ...
                mode: 'school-extracurricular-create-form',
                maxWidth: 'md',
                data: {},
              })
            "
    ...
    <template #content>
      <section>
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800">
            ...
            <table class="w-full text-left text-xs text-gray-500 dark:text-gray-400">
              <thead class="bg-gray-50 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" class="p-4">Ekstrakurikuler</th>
                  <th scope="col" class="p-4">Pembimbing</th>
                  <th scope="col" class="p-4"></th>
                </tr>
              </thead>
              <tbody class="text-xs">
                <tr
                  v-for="(school_extracurricular, index) in school_extracurriculars.data"
                  :key="index"
                ...
                >
                  ...
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ school_extracurricular.title }}
                    </div>
                  </th>
                  <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      {{ school_extracurricular.mentor?.profile?.name ?? '-' }}
                    </div>
                  </th>
                  <td class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center justify-end space-x-3">
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            title: 'Sunting Ekstrakurikuler',
                            mode: 'school-extracurricular-edit-form',
                            maxWidth: 'md',
                            data: {
                              school_extracurricular: school_extracurricular,
                            },
                          })
                        "
                      >
                      ...
                      <Link
                        :href="
                          route('school.management.schoolExtracurricular.detail', {
                            school_extracurricular_id: school_extracurricular.uuid,
                          })
                        "
                      >
                      ...
                      <OutlineButton
                        ...
                        @click="
                          openModal({
                            ...
                            mode: 'school-extracurricular-delete-confirm',
                            maxWidth: 'md',
                            data: {
                              actionUrl: route('school.management.schoolExtracurricular.delete', {
                                school_extracurricular_id: school_extracurricular.uuid,
                              }),
                              redirectUrl: route('school.management.schoolExtracurricular'),
                              message: 'Ingin menghapus Ekstrakurikuler?',
                            },
                          })
                        "
                      >
          ...
          <Pagination
            ...
            :meta="school_extracurriculars.meta"
            :links="school_extracurriculars.links"
          />
        </div>
      </section>
      <!-- modal -->
      <Modal :show="showModal" :property="propertyModal" :maxWidth="propertyModal?.maxWidth" @close="closeModal">
        <template v-slot="{ propertyModal }">
          <SchoolSubjectForm
            v-if="
              propertyModal?.mode == 'school-extracurricular-edit-form' ||
              propertyModal?.mode == 'school-extracurricular-create-form'
            "
            :propertyModal="propertyModal"
            @close="closeModal()"
          />
          <DeleteConfirm
            v-if="propertyModal?.mode == 'school-extracurricular-delete-confirm'"
            :propertyModal="propertyModal"
            @close="closeModal()"
          />
        </template>
