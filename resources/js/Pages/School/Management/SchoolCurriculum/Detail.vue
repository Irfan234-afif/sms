          ...
          >
            <div class="flex items-center justify-between border-b pb-4">
              <h5 class="text-base font-medium leading-none text-gray-900 dark:text-white">
                Kelola Kategori Objektif Pembelajaran
              </h5>
              <DefaultButton
                type="default"
                @click="
                  openModal({
                    title: 'Kategori Objektif Pembelajaran Baru',
                ...
                >
                  <div class="flex items-center space-x-2">
                    ...
                    <OutlineButton
                      ...
                      @click="
                        openModal({
                          title: 'Sunting Kategori Objektif Pembelajaran',
                    ...
                    <OutlineButton
                      ...
                      @click="
                        openModal({
                          title: 'Hapus Kategori Objektif Pembelajaran',
                          ...
                          data: {
                            ...
                            message:
                              'Ingin menghapus Kategori Objektif Pembelajaran? Tindakan ini akan memengaruhi data terkait serta penilaian ke depannya. Apakah Anda yakin ingin melanjutkan?',
                          },
                        })
                      "
                    >
