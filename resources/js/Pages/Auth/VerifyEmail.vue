  ...
  <GuestLayout>
    ...
    >
      ...
      <p class="font-light text-gray-500 dark:text-gray-400">
        ...
        tautan yang baru saja kami kirimkan ke email Anda? Jika Anda tidak menerima email tersebut, kami dengan senang
        hati akan mengirimkan yang baru.
      </p>
      <div class="mb-4 text-xs font-medium text-green-600 dark:text-green-400" v-if="verificationLinkSent">
