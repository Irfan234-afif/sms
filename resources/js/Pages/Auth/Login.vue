...
<template>
  <GuestLayout>
    ...
    <div v-if="status" class="mb-4 text-xs font-medium text-green-600">
      {{ status }}
    </div>
      ...
      <form @submit.prevent="submit" class="space-y-4 md:space-y-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <Link
            ...
            class="text-primary-600 dark:text-primary-500 text-xs font-medium hover:underline"
          >
            Lupa kata sandi?
          </Link>
        </div>
        ...
        <p class="text-xs font-light text-gray-500 dark:text-gray-400">
          Belum punya akun?
          <Link :href="route('register')" class="text-primary-600 dark:text-primary-500 font-medium hover:underline"
            >Daftar</Link
          >
        </p>
      </form>
