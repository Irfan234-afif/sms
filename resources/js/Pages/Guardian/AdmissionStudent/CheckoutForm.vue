    ...
    <div class="space-y-6 p-5">
        ...
        >
            ...
            <div class="ms-3 text-sm font-medium">
                ...
                <span class="font-semibold">{{ student_quota.max_quota - student_quota.used_quota }}</span>
            </div>
        </div>
        <div
        ...
        <div
            class="flex items-center rounded-lg bg-yellow-50 p-4 text-yellow-800 dark:bg-gray-800 dark:text-yellow-300"
        >
            <svg
                class="h-4 w-4 shrink-0"
                aria-hidden="true"
