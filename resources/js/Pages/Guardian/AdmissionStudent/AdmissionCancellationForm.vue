...
<template>
  <div class="space-y-6 p-5 text-center">
    ...
    <div class="flex justify-center space-x-3">
      <DefaultButton type="red" class="w-full md:w-1/2" @click="submit()" :disabled="process">
        Ya, Batalkan Pendaftaran
      </DefaultButton>

      <DefaultButton type="light" class="w-full md:w-1/2" @click="close" :disabled="process">Tidak Jadi</DefaultButton>
    </div>
  </div>
</template>
