          ...
          window.snap.pay(snap_token, {
            ...
            onPending: (gateway_response) => {
              ...
              ElNotification({
                ...
                message: 'Pembayaran Anda tertunda. Silakan selesaikan transaksi segera.',
                type: 'warning',
              });
  ...
  <div class="space-y-6 p-5">
    ...
    <div class="space-y-4">
      <div class="space-y-4 border-gray-200 dark:border-gray-700">
        <h4 class="text-base font-medium text-gray-900 dark:text-white">Informasi</h4>
        <div
          class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 text-xs dark:border-gray-700 dark:bg-gray-800 md:mb-8"
        >
          <dl class="items-center justify-between gap-4 sm:flex">
            <dt class="mb-1 font-normal text-gray-500 dark:text-gray-400 sm:mb-0">Order ID</dt>
            <dd class="font-medium text-gray-900 dark:text-white sm:text-end">
              {{ transaction.reference_number }}
            </dd>
          </dl>
          <dl class="items-center justify-between gap-4 sm:flex">
            <dt class="mb-1 font-normal text-gray-500 dark:text-gray-400 sm:mb-0">Jenis Transaksi</dt>
            <dd class="font-medium text-gray-900 dark:text-white sm:text-end">
              {{ transaction.sub_type_label }}
            </dd>
          </dl>
          <dl class="items-center justify-between gap-4 sm:flex">
            <dt class="mb-1 font-normal text-gray-500 dark:text-gray-400 sm:mb-0">Tempo Pembayaran</dt>
            <dd class="font-medium text-gray-900 dark:text-white sm:text-end">
      ...
      <div class="space-y-4">
        <h4 class="text-base font-medium text-gray-900 dark:text-white">Tagihan</h4>
        <div
      ...
      <div
        ...
        class="mb-4 flex items-center rounded-lg bg-green-50 p-4 text-xs text-green-800 dark:bg-gray-800 dark:text-green-400"
        role="alert"
      >
        <svg
        ...
        <div>
          ...
          Pembayaran telah diterima. Terima kasih telah menyelesaikan pembayaran.
        </div>
      </div>
    </div>
    ...
    <div class="flex justify-end space-x-3" v-else>
      <DefaultButton class="w-full" type="default" @click="close"> Tutup </DefaultButton>
    </div>
  </div>
</template>
