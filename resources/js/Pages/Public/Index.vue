      ...
      <div class="mx-auto flex max-w-screen-2xl flex-wrap items-center justify-between p-4">
        ...
        <div class="flex items-center space-x-1 md:order-2 md:space-x-2 rtl:space-x-reverse">
          <Link
            ...
            :href="route('portal')"
            class="rounded-lg bg-yellow-300 px-4 py-2 text-xs font-medium text-white hover:bg-yellow-400 focus:outline-none focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800 md:px-5 md:py-2.5"
          >
            Portal Anggota
          </Link>
          <template v-else>
            <Link
              :href="route('login')"
              class="rounded-lg px-4 py-2 text-xs font-medium text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-800 md:px-5 md:py-2.5"
            >
              Masuk</Link
            >
            <Link
              :href="route('register')"
              class="rounded-lg bg-blue-700 px-4 py-2 text-xs font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 md:px-5 md:py-2.5"
            >
              Daftar</Link
            >
          </template>
          <button
            ...
            type="button"
            class="inline-flex h-10 w-10 items-center justify-center rounded-lg p-2 text-xs text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 md:hidden"
    ...
    <main class="flex-row">
      ...
      <section class="relative flex h-screen bg-[url('/assets/pages/jumbotron.jpg')] bg-cover bg-fixed bg-no-repeat">
        ...
        <div class="z-10 mx-auto my-auto max-w-5xl py-24 text-center lg:py-56">
          ...
          <p class="mb-8 text-base font-normal text-white sm:px-16 lg:px-48 lg:text-base">
            Menjadi sekolah terbaik dalam layanan, maksimal mencerdaskan generasi berkarakter yang menghasilkan karya
            unggul bagi Indonesia
          </p>
                  ...
                  <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    <li class="flex">
                      <img
                        ...
                        src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi6C5ecQBg9qVpRwiHEaDP9tU3iYsIKrHqmWS5msf-kU7ApKzREqOo_WkiR-ryW_IB6tEMlzMPoUl2JpLGF71TxLbe8y6dzgXFamIUQEH7nM-e0VIaeTrVVd5fxECODfXONhyRfeT9ZJzg9/w1200-h630-p-k-no-nu/logo-flazz-gen-2.png"
                      />
                    </li>
                    <li class="flex">
                      <img
                        ...
                        data-nimg="1"
                        style="color: transparent"
                        src="https://static.cdnlogo.com/logos/m/14/microsoft.svg"
                      />
                    </li>
                    <li class="flex">
                      <img
                    ...
                    <li class="flex">
                      <img
                        ...
                        data-nimg="1"
                        style="color: transparent"
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Logo-ocbc.svg/1280px-Logo-ocbc.svg.png"
                      />
                    </li>
                    <li class="flex">
                      <img
                  ...
                  <ul role="list" class="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    <li class="flex">
                      <img
                        ...
                        data-nimg="1"
                        style="color: transparent"
                        src="https://seremonia.id/wp-content/uploads/2018/10/kemendikbud-logo.png"
                      />
                    </li>
                    <li class="flex">
                      <img
                        ...
                        data-nimg="1"
                        style="color: transparent"
                        src="https://www.cem.org/hs-fs/hubfs/logos/logo-cambridge-assessment-international-education.png?width=430&name=logo-cambridge-assessment-international-education.png"
                      />
                    </li>
                    <li class="flex">
                      <img
                        ...
                        data-nimg="1"
                        style="color: transparent"
                        src="https://fivaldicyberstudio.wordpress.com/wp-content/uploads/2022/01/logo-sekolah-penggerak-3072_945.png"
                      />
                    </li>
                    <li class="flex">
                      <img
                        ...
                        data-nimg="1"
                        style="color: transparent"
                        src="https://png.pngtree.com/png-vector/20230615/ourmid/pngtree-a-accreditation-badge-with-gold-paddy-symbol-vector-png-image_7143730.png"
                      />
                    </li>
                  </ul>
                </li>
      ...
      <section>
        <div class="mx-auto max-w-screen-xl px-4 py-8 text-center lg:py-16">
          ...
          <ol
            role="list"
            class="-mx-3 grid grid-cols-1 gap-y-10 lg:grid-cols-2 lg:text-center xl:-mx-12 xl:divide-x xl:divide-gray-400/20"
          >
            <li
              v-for="index in 2"
              :key="index"
            ...
            >
              ...
              <div>
                ...
                <p class="mt-2 text-xs text-gray-600">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor qui ea fuga aliquam eaque odio quidem
                  sint voluptas impedit rem amet, expedita fugit, tempora, inventore dolore praesentium quos quis in.
                </p>
              </div>
            </li>
          </ol>
          ...
          <ol
            role="list"
            class="-mx-3 grid grid-cols-1 gap-y-10 lg:grid-cols-3 lg:text-center xl:-mx-12 xl:divide-x xl:divide-gray-400/20"
          >
            <li
              v-for="index in 3"
              :key="index"
        ...
        <div class="mx-auto max-w-7xl py-8 lg:py-16">
          <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-4 text-base tracking-tight text-gray-700">
              Dipercaya oleh wali, siswa, dan pengajar. Sekolah kami mengutamakan kemudahan dan fokus pada kualitas
              ...
              <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                <li>
                  <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-gray-900/10">
                    <svg aria-hidden="true" width="105" height="78" class="absolute left-6 top-6 fill-gray-100">
                      <path
                    ...
                    <figcaption class="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                      <div>
                        <div class="font-display text-xs text-gray-900">Sheryl Berge</div>
                        <div class="mt-1 text-xs text-gray-500">CEO at Lynch LLC</div>
                      </div>
                ...
                <li>
                  <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-gray-900/10">
                    ...
                    <figcaption class="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                      <div>
                        <div class="font-display text-xs text-gray-900">Amy Hahn</div>
                        <div class="mt-1 text-xs text-gray-500">Director at Velocity Industries</div>
                      </div>
                      <div class="overflow-hidden rounded-full bg-gray-50">
                        <img
                          alt=""
              ...
              <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                <li>
                  <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-gray-900/10">
                    ...
                    <blockquote class="relative">
                      <p class="text-xs tracking-tight text-gray-900">
                        The best part about TaxPal is every time I pay my employees, my bank balance doesn’t go down
                    ...
                    <figcaption class="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                      <div>
                        <div class="font-display text-xs text-gray-900">Leland Kiehn</div>
                        <div class="mt-1 text-xs text-gray-500">Founder of Kiehn and Sons</div>
                      </div>
                      <div class="overflow-hidden rounded-full bg-gray-50">
                        <img
                          alt=""
                  ...
                  <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-gray-900/10">
                    ...
                    <blockquote class="relative">
                      <p class="text-xs tracking-tight text-gray-900">
                        ...
                        TaxPal. Suspicious but I can’t say I don’t love it.
                      </p>
                    </blockquote>
                    <figcaption class="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                      <div>
                        <div class="font-display text-xs text-gray-900">Erin Powlowski</div>
                        <div class="mt-1 text-xs text-gray-500">COO at Armstrong Inc</div>
                      </div>
                      <div class="overflow-hidden rounded-full bg-gray-50">
                        <img
                          alt=""
              ...
              <ul role="list" class="flex flex-col gap-y-6 sm:gap-y-8">
                <li>
                  <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-gray-900/10">
                    ...
                    <figcaption class="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                      <div>
                        <div class="font-display text-xs text-gray-900">Peter Renolds</div>
                        <div class="mt-1 text-xs text-gray-500">Founder of West Inc</div>
                      </div>
                      <div class="overflow-hidden rounded-full bg-gray-50">
                        <img
                          alt=""
                ...
                <li>
                  <figure class="relative rounded-2xl bg-white p-6 shadow-xl shadow-gray-900/10">
                    ...
                    <blockquote class="relative">
                      <p class="text-xs tracking-tight text-gray-900">
                        This is the fourth email I’ve sent to your support team. I am literally being held in jail for
                        tax fraud. Please answer your damn emails, this is important.
                      </p>
                    </blockquote>
                    <figcaption class="relative mt-6 flex items-center justify-between border-t border-gray-100 pt-6">
                      <div>
