        ...
        <div class="mx-auto max-w-7xl py-8 lg:py-16">
          <div class="mx-auto max-w-7xl">
            <div class="grid grid-cols-3 gap-4">
              ...
              >
                <img class="h-64 rounded-t-lg object-cover" :src="news.thumbnail_path" alt="" />
                <div class="flex flex-grow flex-col p-5">
                  ...
                  <div class="mt-auto w-full pt-3">
                    ...
                    <div class="inline-flex w-full items-center border-t pt-4 text-sm text-gray-900 dark:text-white">
                      <img class="mr-4 h-10 w-10 rounded-full" :src="news.author.avatar_path" alt="Jese Leos" />
                      <div>
                        <div class="text-base font-medium text-gray-900 dark:text-white">{{ news.author.name }}</div>
            ...
            <div class="mt-2">
              <Pagination class="bg-white" :meta="news.meta" :links="news.links" />
            </div>
          </div>
        </div>
      </section>
