...
const c = { class: 'min-h-screen bg-gray-100 dark:bg-gray-900' },
  ...
  B = { class: 'block truncate text-xs text-gray-900 dark:text-white' },
  j = { class: 'py-1 text-gray-700 dark:text-gray-300', 'aria-labelledby': 'dropdown' },
  S = { class: 'py-1 text-gray-700 dark:text-gray-300', 'aria-labelledby': 'dropdown' },
  C = {
    class:
  ...
  $ = { class: '-mt-1 flex h-screen flex-col overflow-hidden pt-16 md:ml-64' },
  H = { class: 'border-gray-200 bg-white' },
  P = { class: 'flex-1 overflow-y-auto' },
  L = {
    mounted() {
      p();
    },
    ...
    setup(u) {
      return (r, e) => (
        ...
        g('div', c, [
          t('nav', y, [
            t('div', w, [
              t('div', f, [
                ...
                a(
                  s(d),
                  { href: r.route('guardian'), class: 'mr-4 flex items-center justify-between' },
                  {
                    default: o(
                      () =>
                        e[0] ||
              ...
              t('div', m, [
                ...
                t('div', _, [
                  t('div', M, [
                    t('span', z, l(r.$page.props.auth.user.name), 1),
                    t('span', B, l(r.$page.props.auth.user.email), 1),
                  ]),
                  t('ul', j, [
                    t('li', null, [
                      a(
                        ...
                        { default: o(() => e[6] || (e[6] = [i('Pengaturan Akun')])), _: 1 },
                      ),
                    ]),
                  ]),
                  t('ul', S, [
                    t('li', null, [
                      a(
                        ...
                        { default: o(() => e[7] || (e[7] = [i('Keluar Portal')])), _: 1 },
                        8,
                        ['href'],
                      ),
                    ]),
          ...
          t('aside', C, [n(r.$slots, 'sidebar')]),
          t('main', $, [t('section', H, [n(r.$slots, 'header')]), t('section', P, [n(r.$slots, 'content')])]),
        ])
      );
    },
  }),
  N = { class: 'h-screen overflow-y-auto bg-white px-3 py-1 dark:bg-gray-800' },
  V = { class: 'space-y-2' },
  G = {
    mounted() {
      p();
            ...
            t('ul', V, [
              t('li', null, [
                a(
                  ...
                  { default: o(() => e[0] || (e[0] = [t('span', null, 'Wali', -1)])), _: 1 },
                  8,
                  ['href'],
                ),
              ]),
              ...
              t('li', null, [
                a(
                  s(d),
                  {
                    href: r.route('guardian.admissionStudent'),
                    class:
                      'group flex items-center rounded-lg p-2 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700',
                  },
                  {
                    default: o(
                      () =>
                        ...
                        (e[2] = [
                          ...
                          t('span', { class: 'ml-3 flex-1 whitespace-nowrap' }, 'Pendaftaran Siswa Baru', -1),
                        ]),
                    ),
                    _: 1,
                  },
              ...
              t('li', null, [
                a(
                  s(d),
                  {
                    href: r.route('guardian.transactionPayment'),
                    class:
                      'group flex items-center rounded-lg p-2 text-xs font-medium text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700',
                  },
                  {
                    default: o(
                      () =>
                        ...
                        (e[3] = [
                          ...
                          t('span', { class: 'ml-3 flex-1 whitespace-nowrap' }, 'Tagihan & Pembayaran', -1),
                        ]),
                    ),
                    _: 1,
                  },
