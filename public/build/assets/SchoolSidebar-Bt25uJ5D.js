...
const v = { class: 'min-h-screen bg-gray-100 dark:bg-gray-900' },
  f = {
    class:
      'fixed left-0 right-0 top-0 z-50 border-b border-gray-200 bg-white px-4 py-2.5 dark:border-gray-700 dark:bg-gray-800',
  },
  y = { class: 'flex flex-wrap items-center justify-between' },
  k = { class: 'flex items-center justify-start' },
  m = { class: 'flex items-center lg:order-2' },
  c = {
    class:
  ...
  z = { class: 'px-4 py-3' },
  B = { class: 'block text-xs font-medium text-gray-900 dark:text-white' },
  _ = { class: 'block truncate text-xs text-gray-900 dark:text-white' },
  j = { class: 'py-1 text-gray-700 dark:text-gray-300', 'aria-labelledby': 'dropdown' },
  C = { class: 'py-1 text-gray-700 dark:text-gray-300', 'aria-labelledby': 'dropdown' },
  S = {
    class:
  ...
  H = { class: '-mt-1 flex h-screen flex-col overflow-hidden pt-16 md:ml-64' },
  $ = { class: 'border-gray-200 bg-white' },
  L = { class: 'flex-1 overflow-y-auto' },
  P = {
    mounted() {
      x();
    },
    ...
    setup(w) {
      return (s, e) => (
        ...
        p('div', v, [
          t('nav', f, [
            t('div', y, [
              t('div', k, [
                ...
                r(
                  o(l),
                  { href: s.route('school'), class: 'mr-4 flex items-center justify-between' },
                  {
                    default: a(
                      () =>
                        e[0] ||
              ...
              t('div', m, [
                ...
                e[15] ||
                  (e[15] = t(
                    ...
                    [
                      t('span', { class: 'sr-only' }, 'View notifications'),
                      t(
                        'svg',
                        {
                          class: 'h-6 w-6',
                ...
                t('div', M, [
                  t('div', z, [
                    t('span', B, h(s.$page.props.auth.user.name), 1),
                    t('span', _, h(s.$page.props.auth.user.email), 1),
                  ]),
                  t('ul', j, [
                    t('li', null, [
                      r(
                        ...
                        { default: a(() => e[13] || (e[13] = [n('Pengaturan Akun')])), _: 1 },
                      ),
                    ]),
                  ]),
                  t('ul', C, [
                    t('li', null, [
                      r(
                        ...
                        { default: a(() => e[14] || (e[14] = [n('Keluar Portal')])), _: 1 },
                        8,
                        ['href'],
                      ),
                    ]),
          ...
          t('aside', S, [i(s.$slots, 'sidebar')]),
          t('main', H, [t('section', $, [i(s.$slots, 'header')]), t('section', L, [i(s.$slots, 'content')])]),
        ])
      );
    },
  }),
  V = { class: 'h-screen overflow-y-auto bg-white px-3 py-1 dark:bg-gray-800' },
  K = { class: 'space-y-2' },
  N = { id: 'dropdown-activity', class: 'hidden space-y-2 py-2' },
  A = { id: 'dropdown-management', class: 'hidden space-y-2 py-2' },
  G = { id: 'dropdown-setting', class: 'hidden space-y-2 py-2' },
  O = { class: 'mt-5 space-y-2 border-t border-gray-200 pt-5 dark:border-gray-700' },
  T = {
    mounted() {
      x();
    },
            ...
            t('ul', K, [
              t('li', null, [
                r(
                  ...
                  { default: a(() => e[0] || (e[0] = [t('span', null, 'Sekolah', -1)])), _: 1 },
                  8,
                  ['href'],
                ),
              ]),
                      ...
                      () =>
                        ...
                        (e[1] = [
                          t(
                            ...
                            [
                              t('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }),
                              t('path', { d: 'M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0' }),
                              t('path', { d: 'M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2' }),
                              t('path', { d: 'M16 3.13a4 4 0 0 1 0 7.75' }),
                              t('path', { d: 'M21 21v-2a4 4 0 0 0 -3 -3.85' }),
                            ],
                            -1,
                          ),
                          t('span', { class: 'ml-3 flex-1 whitespace-nowrap' }, 'Staf & Guru', -1),
                        ]),
                    ),
                    _: 1,
                  },
                ...
                t('ul', N, [
                  t('li', null, [
                    r(
                      o(l),
                      {
                        href: s.route('school.activity.admissionStudent'),
                        class:
                      ...
                      { default: a(() => e[3] || (e[3] = [n('Pendaftaran Siswa Baru')])), _: 1 },
                      8,
                      ['href'],
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[4] || (e[4] = [n('Kegiatan Belajar Mengajar')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[5] || (e[5] = [n('Rapor Siswa Sekolah')])), _: 1 },
                    ),
                  ]),
                ]),
              ]),
                ...
                t('ul', A, [
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[7] || (e[7] = [n('Tahun Ajaran')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[8] || (e[8] = [n('Kurikulum')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[9] || (e[9] = [n('Grup Mata Pelajaran')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[10] || (e[10] = [n('Mata Pelajaran')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[11] || (e[11] = [n('Ruang Kelas')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[12] || (e[12] = [n('Ekstrakurikuler')])), _: 1 },
                    ),
                  ]),
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[13] || (e[13] = [n('Klub')])), _: 1 },
                    ),
                  ]),
                ]),
              ]),
                ...
                t('ul', G, [
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[15] || (e[15] = [n('Sekolah')])), _: 1 },
                    ),
                  ]),
                ]),
              ]),
                    ...
                    default: a(
                      () =>
                        ...
                        (e[17] = [
                          ...
                          t('span', { class: 'ml-3 flex-1 whitespace-nowrap text-left' }, 'Staf', -1),
                          t(
                            'svg',
                            {
                              xmlns: 'http://www.w3.org/2000/svg',
                    ...
                    default: a(
                      () =>
                        ...
                        (e[18] = [
                          ...
                          t('span', { class: 'ml-3 flex-1 whitespace-nowrap text-left' }, 'Guru', -1),
                          t(
                            'svg',
                            {
                              xmlns: 'http://www.w3.org/2000/svg',
