import { _ as w } from './OfficeLayout-CodOKVs_.js';
import {
  w as a,
  k as c,
  s as d,
  ...
  b as t,
  m as v,
} from './app-BL89rjcW.js';
const f = { class: 'h-screen overflow-y-auto bg-white px-3 py-1 dark:bg-gray-800' },
  m = { class: 'space-y-2' },
  y = { id: 'dropdown-approval', class: 'hidden space-y-2 py-2' },
  M = { id: 'dropdown-management', class: 'hidden space-y-2 py-2' },
  b = { id: 'dropdown-setting', class: 'hidden space-y-2 py-2' },
  z = { class: 'mt-5 space-y-2 border-t border-gray-200 pt-5 dark:border-gray-700' },
  B = {
    mounted() {
      c();
    },
                ...
                t('ul', y, [
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[1] || (e[1] = [l('Pelatihan')])), _: 1 },
                    ),
                  ]),
                ]),
              ]),
                ...
                t('ul', M, [
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[3] || (e[3] = [l('Modul Pelatihan')])), _: 1 },
                    ),
                  ]),
                ]),
              ]),
                ...
                t('ul', b, [
                  t('li', null, [
                    r(
                      ...
                      { default: a(() => e[5] || (e[5] = [l('Petugas Persetujuan')])), _: 1 },
                    ),
                  ]),
                ]),
              ]),
  ...
  H = { class: 'w-full md:w-1/3' },
  D = {
    __name: 'Index',
    setup(g) {
      return (n, e) => {
        const u = i('Breadcrumb'),
          x = i('Search');
        return (
          p(),
          h(
            ...
            [
              ...
              r(w, null, {
                header: a(() => [
                  r(u, { breadcrumbs: n.breadcrumbs }, null, 8, ['breadcrumbs']),
                  t('div', j, [t('div', H, [r(x, { search_params: n.search_params }, null, 8, ['search_params'])])]),
                ]),
                sidebar: a(() => [r(C)]),
                content: a(
                  () =>
                    ...
                    (e[0] = [
                      t(
                        'section',
                        { class: 'bg-white p-4 antialiased dark:bg-gray-900 md:p-6' },
                        [
                          t('div', { class: 'px-4 2xl:px-0' }, [
                            t(
                              'h1',
                              { class: 'mb-4 text-base font-medium text-gray-900 dark:text-white md:mb-6' },
                              'Overview',
                            ),
                            t(
                              'div',
                              {
                                class:
                                  'grid grid-cols-2 gap-6 border-t border-gray-200 pt-4 text-xs dark:border-gray-700 md:pt-8 lg:grid-cols-4 xl:gap-16',
                              },
                              [
                                t('div', null, [
                                  t(
                                    ...
                                    [
                                      t('path', { stroke: 'none', d: 'M0 0h24v24H0z', fill: 'none' }),
                                      t('path', { d: 'M12 16v.01' }),
                                      t('path', { d: 'M12 13a2 2 0 0 0 .914 -3.782a1.98 1.98 0 0 0 -2.414 .483' }),
                                      t('path', { d: 'M10 20.777a8.942 8.942 0 0 1 -2.48 -.969' }),
                                      t('path', { d: 'M14 3.223a9.003 9.003 0 0 1 0 17.554' }),
                                      t('path', { d: 'M4.579 17.093a8.961 8.961 0 0 1 -1.227 -2.592' }),
                                      t('path', { d: 'M3.124 10.5c.16 -.95 .468 -1.85 .9 -2.675l.169 -.305' }),
                                      t('path', { d: 'M6.907 4.579a8.954 8.954 0 0 1 3.093 -1.356' }),
                                    ],
                                  ),
                                  t(
                                    'h6',
                                  ...
                                  t(
                                    'span',
                                    { class: 'flex items-center text-base font-medium text-gray-900 dark:text-white' },
                                    '24 ',
                                  ),
                                  t(
                                    'p',
                                    {
                                      class:
                                        'mt-2 flex items-center text-xs text-gray-500 dark:text-gray-400 sm:text-xs',
                                    },
                                    [
                                      t(
                                        'svg',
